            ...
            <?php foreach ($enquiries as $enquiry) { ?>
              <div class="panel panel-default clearfix">
                <div class="panel-seller">
                  <label><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /> <?php echo $column_store_owner; ?></label>
                ...
                <div class="panel-inner">
                  <div class="panel-heading">
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="cust"><b><?php echo $column_customer_name; ?>: <?php echo $enquiry['name']; ?></b></div>
                      </div>
                      <div class="col-sm-4">
                        <div class="email text-center"><b><?php echo $column_customer_email; ?>: <?php echo $enquiry['email']; ?></b></div>
                      </div>
                      <div class="col-sm-4 text-right">
                        <div class="date">
                          <b><?php echo $column_date_added; ?>: <?php echo $enquiry['date_added']; ?></b>
                          <a data-link="<?php echo $enquiry['view']; ?>" data-enquiry="<?php echo $enquiry['mpseller_enquiry_id']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn-sm btn-primary button-info button-info<?php echo $enquiry['mpseller_enquiry_id']; ?>"><i class="fa fa-eye"></i></a>
                        </div>
...
$('.button-info').on('click', function() {
  var enquiry_id = $(this).attr('data-enquiry');
  var link_url = $(this).attr('data-link');
  $.ajax({
    url: link_url,
    dataType: 'html',
    beforeSend: function() {
        $('.button-info'+ enquiry_id).button('loading');
    },
    complete: function() {
      $('.button-info'+ enquiry_id).button('reset');
    },
...
$('#button-filter').on('click', function() {
  var url = 'index.php?route=mpmultivendor/enquiries&user_token=<?php echo $user_token; ?>';
