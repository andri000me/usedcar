...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_entry_status'])) {
			$filter_entry_status = $this->request->get['filter_entry_status'];
		} else {
			$filter_entry_status = '';
		}

		if (isset($this->request->get['filter_expired_status'])) {
			$filter_expired_status = $this->request->get['filter_expired_status'];
		} else {
		...
		if (isset($this->request->get['filter_entry_status'])) {
			$url .= '&filter_entry_status=' . $this->request->get['filter_entry_status'];
		}

		if (isset($this->request->get['filter_expired_status'])) {
			$url .= '&filter_expired_status=' . $this->request->get['filter_expired_status'];
		}
		...
		$filter_data = array(
			...
			'filter_entry_status' => $filter_entry_status,
			'filter_expired_status' => $filter_expired_status,
			'sort'            => $sort,
			'order'           => $order,
		...
		$data['filter_entry_status'] = $filter_entry_status;
		$data['filter_expired_status'] = $filter_expired_status;
