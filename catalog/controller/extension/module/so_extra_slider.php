	...
	public function readData($setting) { 
		...
		if(!empty($products_arr)){
			foreach($products_arr as $product)
			{
				...
				$results = $this->model_catalog_product->getProductAttributesProduct($product_info['product_id']);
				foreach ($results as $result) {
					$attribute_data['ListAttributes'][]= array(
				...
				$data['products'][] = array(
					...
					'tax'         	=> $tax,
					'rating'      	=> $rating,
					'years'	=>$product_info['years'],
					'tipe'	=>$product_info['tipe'],
					'seri'	=>$product_info['seri'], 
					'merk'	=>$product_info['manufacturer'],
					'attributes'=>$results ,
